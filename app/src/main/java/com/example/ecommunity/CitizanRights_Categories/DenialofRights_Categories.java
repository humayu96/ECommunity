...
public class DenialofRights_Categories extends AppCompatActivity {
    ListView listView;
    ArrayAdapter<String> arrayAdapter;
    String[] listitems = {"Denial of Rights","General Complaints","Corruption"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_denialof_rights__categories);
        // Database Connection
        ...
        listView = (ListView) findViewById(R.id.lv_DenialofRights);
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (position == 0 ){
                            newPost.child("ComplaintCategory").setValue("Denial of Rights");

                            Intent intent = new Intent(DenialofRights_Categories.this, SubmitComplaints_Activity.class);
