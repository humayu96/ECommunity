...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_phone = (EditText) findViewById(R.id.phonenumb_ed);
        edit_code = (EditText) findViewById(R.id.signup_code);
        put_code = (Button)findViewById(R.id.signup_button);
        countryCodePicker.registerCarrierNumberEditText(edit_phone);

        put_code.setEnabled(false);
        edit_code.setEnabled(false);

        get_code = (Button)findViewById(R.id.code_button);
        get_code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                sendVerificationCode();
                PhoneNumberValidation();
                Toast.makeText(SignUpActivity.this,"Code Sent",Toast.LENGTH_LONG).show();
            }
        });
