...
public class MotorwayPolice_Categories extends AppCompatActivity {
    ListView listView;
    ArrayAdapter<String> arrayAdapter;
    String[] listitems = {"Over Speed Chalan","Illegal Activities","Non-Cooperation","Harassment","General Complaints","Corruption"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_motorway_police__categories);
        // Database Connection
        ...
        listView = (ListView) findViewById(R.id.lv_MotorwayPolice_Categories);
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (position == 0) {
                            newPost.child("ComplaintCategory").setValue("Over Speed Chalan");

                            Intent intent = new Intent(MotorwayPolice_Categories.this, SubmitComplaints_Activity.class);
                            startActivity(intent);
                        }
                        if (position == 1) {
                            newPost.child("ComplaintCategory").setValue("Illegal Activities");
