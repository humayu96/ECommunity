...
public class Colleges_Categories extends AppCompatActivity {
    ListView listView;
    ArrayAdapter<String> arrayAdapter;
    String[] listitems = {"Admission / Enrolment","False or misLeading information","Gender, Race, Cast Discimination","Harassment"
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_colleges__categories);
        // Database Connection
        ...
        listView = (ListView) findViewById(R.id.lv_Colleges);
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (position == 0 ){
                            ...
                            Intent intent = new Intent(Colleges_Categories.this, SubmitComplaints_Activity.class);
                            startActivity(intent);
                        }if (position == 1 ){
                            newPost.child("ComplaintCategory").setValue("False or misLeading information");

                            Intent intent = new Intent(Colleges_Categories.this, SubmitComplaints_Activity.class);
                            startActivity(intent);
                        }if (position == 2 ){
                            newPost.child("ComplaintCategory").setValue("Gender, Race, Cast Discimination");
                            ...
                            newPost.child("Complaint Category").setValue("UnFair Results");
