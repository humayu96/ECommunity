...
public class HigherEducationCommission_Categories extends AppCompatActivity {
    ListView listView;
    ArrayAdapter<String> arrayAdapter;
    String[] listitems = {"General Complaints","Corruption"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_higher_education_commission__categories);
        // Database Connection
        ...
        listView = (ListView) findViewById(R.id.lv_HEC);
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (position == 0) {
                            ...
                            Intent intent = new Intent(HigherEducationCommission_Categories.this, SubmitComplaints_Activity.class);
