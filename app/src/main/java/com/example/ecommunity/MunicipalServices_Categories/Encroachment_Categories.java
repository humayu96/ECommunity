...
public class Encroachment_Categories extends AppCompatActivity {
    ListView listView;
    ArrayAdapter<String> arrayAdapter;
    String[] listitems = {"Temporary Encroachment","Permanent Encroachment","Private Property Encroachment",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_encroachment__categories);
        // Database Connection
        ...
        listView = (ListView) findViewById(R.id.lv_Encroachment_Categories);
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (position == 0) {
                            newPost.child("ComplaintCategory").setValue("Temporary Encroachment");

                            Intent intent = new Intent(Encroachment_Categories.this, SubmitComplaints_Activity.class);
                            startActivity(intent);
                        }
                        if (position == 1) {
                            newPost.child("ComplaintCategory").setValue("Permanent Encroachment");

                            Intent intent = new Intent(Encroachment_Categories.this, SubmitComplaints_Activity.class);
                            startActivity(intent);
                        }
                        if (position == 2) {
                            newPost.child("ComplaintCategory").setValue("Private Property Encroachment");
