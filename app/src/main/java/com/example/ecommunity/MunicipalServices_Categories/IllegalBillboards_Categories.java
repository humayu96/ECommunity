...
public class IllegalBillboards_Categories extends AppCompatActivity {
    ListView listView;
    ArrayAdapter<String> arrayAdapter;
    String[] listitems = {"Illegal Size","Illegal Location","Risky Billboards",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_illegal_billboards__categories);
        // Database Connection
        ...
        listView = (ListView) findViewById(R.id.lv_IllegalBillboards_Categories);
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (position == 0) {
                            newPost.child("ComplaintCategory").setValue("Illegal Size");

                            Intent intent = new Intent(IllegalBillboards_Categories.this, SubmitComplaints_Activity.class);
                            startActivity(intent);
                        }
                        if (position == 1) {
                            newPost.child("ComplaintCategory").setValue("Illegal Location");

                            Intent intent = new Intent(IllegalBillboards_Categories.this, SubmitComplaints_Activity.class);
                            startActivity(intent);
                        }
                        if (position == 2) {
                            newPost.child("ComplaintCategory").setValue("Risky Billboards");
