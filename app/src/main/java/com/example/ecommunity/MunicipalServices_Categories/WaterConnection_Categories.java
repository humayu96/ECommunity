...
public class WaterConnection_Categories extends AppCompatActivity {
    ListView listView;
    ArrayAdapter<String> arrayAdapter;
    String[] listitems = {"Demand of Water Supply Scheme","Broken Pipelines",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_water_connection__categories);
        // Database Connection
        ...
        listView = (ListView) findViewById(R.id.lv_WaterConnection_Categories);
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (position == 0) {
                            newPost.child("ComplaintCategory").setValue("Demand of Water Supply Scheme");

                            Intent intent = new Intent(WaterConnection_Categories.this, SubmitComplaints_Activity.class);
                            startActivity(intent);
                        }
                        if (position == 1) {
                            newPost.child("ComplaintCategory").setValue("Broken Pipelines");
